package com.sirmaacademy.professionalprogram.inheritanceandinterfaces.inventoryManagementSystem.service.initialLoad;

import com.sirmaacademy.professionalprogram.inheritanceandinterfaces.inventoryManagementSystem.enums.Category;
import com.sirmaacademy.professionalprogram.inheritanceandinterfaces.inventoryManagementSystem.service.implementation.*;
...
public class InitialData {
    ...
    /**
     * Method reads all data from com.sirmaacademy.professionalprogram.streamsandfiles.resources.itemsData.txt and returns Map from valid data.
    ...
    public static Map<Integer, InventoryItem> loadItems(List<String> wrongDataFormat, List<InventoryItem> expiredProductsList) {
        ...
        File itemsData = new File("src/com/sirmaacademy/professionalprogram/inheritanceandinterfaces/inventoryManagementSystem/resources/itemsData.txt");
