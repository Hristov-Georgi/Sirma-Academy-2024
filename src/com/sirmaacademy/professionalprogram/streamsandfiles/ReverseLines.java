...
public class ReverseLines {
    public static void main(String[] args){
        File readFrom = new File("src/com/sirmaacademy/professionalprogram/streamsandfiles/resources/input.txt");
        File writeTo = new File("src/com/sirmaacademy/professionalprogram/streamsandfiles/resources/output.txt");
