...
public class MergeLinesFromTwoFiles {
    public static void main(String[] args) throws IOException {
        ...
        File file1 = new File("src/resources/input1.txt");
        File file2 = new File("src/resources/input2.txt");

        try (BufferedReader reader1 = new BufferedReader(new FileReader(file1));
             BufferedReader reader2 = new BufferedReader(new FileReader(file2));
             BufferedWriter writer = new BufferedWriter(new PrintWriter("src/resources/output.txt"))) {
